...
def sync_muse_w_psychopy(experiment_Ref, win_ref, expInfo, frameTolerance, defaultKeyboard, endExpNow,lang):
    ...
    sync_texts = {
                 ...
                 'de' : '* STOP! *\n\n Drücken Sie KEINE Taste, bevor die Versuchsleitung anwesend ist!! \n\n Bitten Sie die Versuchsleitung, zu Ihnen zu kommen, bevor Sie fortfahren!! \n\n\n Bitte drücken Sie mit Ihrer Hand mit der Uhrviermal aus großer Höhe die [LEERTASTE], bis die nächste Folie erscheint.'
                 }
    continue_texts = {
                 'en' : 'Thank you!\n\nDuring the experiment, please try to avoid talking and big body movements as much as possible.\n\nPress [ENTER] to continue.',
                 'de' : 'Vielen Dank!\ n\n Bitte vermeiden Sie es, so weit es Ihnen möglich ist, während des Versuchs zu sprechen oder sich stark zu bewegen.\n\n Bitte drücken Sie [ENTER] um fortzufahren.'
                }
    
    text_to_display_for_sync=sync_texts[lang] 
    
    text_to_display_for_continuation=continue_texts[lang] 
