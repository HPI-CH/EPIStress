...
SUDOKU_TEXT = {
    'easy': {
        'de': 'Die nächste Aufgabe ist ein einfaches Sudoku-Spiel. Bitte drücken Sie die [LEERTASTE], wenn Sie bereit sind.',
        'en': 'The next task is an Sudoku easy game.  \n   Press [SPACE] when ready..'
    },
    'hard': {
        'de': 'Die nächste Aufgabe ist ein schwieriges Sudoku-Spiel. Bitte drücken Sie die [LEERTASTE], wenn Sie bereit sind.',
        'en': 'The next task is a  Sudoku hard game. \n   Press [SPACE] when ready.'
    }
}



def sudoku(lang, win, seconds_per_routine, experiment_Ref, frameTolerance, defaultKeyboard, endExpNow, easy=True):
    ...
    #test_text = f'Die nächste Aufgabe ist ein {"einfaches" if easy else "schwieriges"} Sudoku-Spiel. Bitte drücken Sie die [LEERTASTE], wenn Sie bereit sind.'
    key = 'easy' if easy else 'hard'
    test_text = SUDOKU_TEXT[key][lang]
    #F'The next task is a Sudoku {"easy" if easy else "hard"} game.  \n   Press [SPACE] when ready.'
