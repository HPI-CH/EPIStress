...
def _nback(lang, continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref, poly_ref, key_resp, def_keyresp,
...
def nback(lang , continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref, easy=True, timer_time_actual=600, timer_time_example=30, base_path=None, frameTolerance=None, endExpNow=None, defaultKeyboard=None, expInfo=None, num_reps=None, with_timer=True):
    ...
    NBACK_TEXT = {
        'welcome': {
            'en': (
                "You will now start with the n-back memory task.\n\n"
            ...
            'de': (
                "Sie beginnen nun mit der 'n-back-Memory' Aufgabe.\n\n"
                "Bitte beachten Sie die Abfolge farbiger Quadrate, und entscheiden Sie, ob Sie dasselbe Quadrat n-Schritte zuvor gesehen haben ('n-back').\n"
                "Es wird verschiedene Abschnitte des Tests geben, die unterschiedliche Werte für „n“ haben. Jedes Mal wenn sich der Wert von 'n' ändert, werden Sie einen Probeversuch haben.\n\n"
                "Drücken Sie die [Leertaste], um fortzufahren."
            )
        },
        'example_instr_1': {
            'en': (
                "n = 1. This is a short 1-back practice to help you get started.\n"
                "Press [SPACE] if the coloured square one trial ago was the same as the current one.\n"
                "Press [SPACE] only when you decide the square was repeated.\n"
                "You will hear a negative sound for a mistake and a positive one for a correct answer.\n\n"
                "Press [SPACE] to begin."
            ),
            'de': (
                "n = 1. Dies ist ein kurzer '1-back' Probeversuch, um Ihnen den Ablauf zu verdeutlichen.\n"
                "Sie müssen die [Leertaste] drücken, wenn das farbige Quadrat des letzten Versuches identisch zum aktuellen Quadrat ist.\n"
                "Bitte drücken Sie [Leertaste] nur, wenn Sie entscheiden, dass das Quadrat wiederholt wurde.\n"
                "Bei einem Fehler hören Sie einen unangenehmen Ton, bei einer richtigen Antwort einen positiven Ton.\n\n"
                "Drücken Sie die [Leertaste], um zu beginnen."
            )
        },
        'example_instr_2': {
            'en': (
                "n = 2. This is a short 2-back practice to help you get started.\n"
                "Press [SPACE] if the coloured square two trials ago was the same as the current one.\n"
                "Press [SPACE] only when you decide the square was repeated.\n"
                "You will hear a negative sound for a mistake and a positive one for a correct answer.\n\n"
                "Press [SPACE] to begin."
            ),
            'de': (
                "n = 2. Dies ist ein kurzer '2-back' Probeversuch, um Ihnen den Ablauf zu verdeutlichen.\n"
                "Sie müssen die [Leertaste] drücken, wenn das farbige Quadrat des vorletzten Versuches identisch zum aktuellen Quadrat ist.\n"
                "Bitte drücken Sie [Leertaste] nur, wenn Sie entscheiden, dass das Quadrat wiederholt wurde.\n"
                "Bei einem Fehler hören Sie einen unangenehmen Ton, bei einer richtigen Antwort einen positiven Ton.\n\n"
                "Drücken Sie die [Leertaste], um zu beginnen."
            )
        },
        'trial_instr_actual_1': {
            'en': "The actual task starts now! n = 1\n\nPress [SPACE] to continue.",
            'de': r"Jetzt beginnt die eigentliche Aufgabe mit n = 1! Bitte drücken Sie die [Leertaste] um fortzufahren."
        },
        'trial_instr_actual_2': {
            'en': "The actual task starts now! n = 2\n\nPress [SPACE] to continue.",
            'de': r"Jetzt beginnt die eigentliche Aufgabe mit n = 2! Bitte drücken Sie die [Leertaste] um fortzufahren."
        }
       }
    ...
    text_4 = visual.TextStim(win=win_ref, name='text_4',
                             #text="Sie beginnen nun mit der 'n-back-Memory' Aufgabe.\n\n Bitte beachten Sie die Abfolge farbiger Quadrate, und entscheiden Sie, ob Sie dasselbe Quadrat n-Schritte zuvor gesehen haben ('n-back'). \n Es wird verschiedene Abschnitte des Tests geben, die unterschiedliche Werte für „n“ haben. Jedesmal wenn sich der Wert von 'n' ändert, werden Sie einen Probeversuch haben.\n\n Drücken Sie die [Leertaste], um fortzufahren.",#"You will now start with the n-back memory task.\n\nYou will be asked to pay attention to a sequence of coloured squares and decide whether you have seen the same square 'n' times before. \nThere will be different sections of the test, which have different values for 'n'.  We will give you a trial session when the value of 'n' changes.\n\nPress [SPACE] to continue.",
                             text=NBACK_TEXT['welcome'][lang],
                             font='Arial',
    ...
    if easy:
        '''text_nback_instructions = ("n = 1. Dies ist ein kurzer '1-back' Probeversuch, um Ihnen den Ablauf zu verdeutlichen. "
                                                        "Sie müssen die [LEERTASTE] dann drücken, wenn das farbige Quadrat des letzten Versuches identisch zu dem aktuellen Quadrat ist. "
                                                        "Bitte drücken Sie [LEERTASTE] nur, wenn Sie entscheiden, dass das farbige Quadrat wiederholt wurde. "
                                                        "Beachten Sie, dass Sie bei einem Fehler einen unangenehmen Warnton hören werden, und bei einer richtigen Antwort einen positiven Ton. "
                                                        "Drücken Sie die [Leertaste], um zu beginnen."
                                                        )'''
        text_nback_instructions = NBACK_TEXT['example_instr_1'][lang]
        ...
        text_nback_instructions = NBACK_TEXT['example_instr_2'][lang]
        '''text_nback_instructions = ("n = 2. Dies ist ein kurzer '2-back' Probeversuch, um Ihnen den Ablauf zu verdeutlichen. "
                                                        "Sie müssen die [LEERTASTE] dann drücken, wenn das farbige Quadrat des vorletzten Versuches identisch zu dem aktuellen Quadrat ist. "
                                                        "Bitte drücken Sie [LEERTASTE] nur, wenn Sie entscheiden, dass das farbige Quadrat wiederholt wurde. "
                                                        "Beachten Sie, dass Sie bei einem Fehler einen unangenehmen Warnton hören werden, und bei einer richtigen Antwort einen positiven Ton."
                                                        "Drücken Sie die [Leertaste], um zu beginnen."
                                                        ) ,      ''' 
    ...
    if easy:
        #text_nback_instructions1_actual = r'Jetzt beginnt die eigentliche Aufgabe mit n = 1! Bitte drücken Sie die [Leertaste] um fortzufahren.'
        #'\n\nThe actual task starts now!\n\nn = 1\n\nPlease press [SPACE] to continue.'
        text_nback_instructions1_actual = NBACK_TEXT['trial_instr_actual_1'][lang]
    else:
       # text_nback_instructions1_actual = r'Jetzt beginnt die eigentliche Aufgabe mit n = 2! Bitte drücken Sie die [Leertaste] um fortzufahren.',
        #'\n\nThe actual task starts now!\n\nn = 2\n\nPlease press [SPACE] to continue.'
        text_nback_instructions1_actual = NBACK_TEXT['trial_instr_actual_2'][lang]
    ...
    _nback(lang, continueRoutine_Part=continueRoutine_Part, experiment_Ref=experiment_Ref,
