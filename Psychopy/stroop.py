...
STROOP_TEXT = {
    'text_2': {
        'de': (
            "In der nächsten Aufgabe sehen Sie die Namen von Farben, abgebildet in derselben "
            "oder einer anderen Schriftfarbe. Wählen Sie die Schriftfarbe der folgenden Farbnamen "
            "und ignorieren Sie das eigentliche Wort. Drücken Sie schnell: \n\n"
            "rot = r \ngrün = g \nblau = b \ngelb = y \n\n"
            "Sie starten jetzt eine Probesitzung.\n\n"
            "Drücken Sie die [Leertaste] um zu beginnen."
        ),
        'en': (
            "In the next task you will see color names displayed in the same or a different font color. "
            "Choose the font color of each name and ignore the word itself. Press quickly:\n\n"
            "red = r\ngreen = g\nblue = b\nyellow = y\n\n"
            "You will now start a practice session.\n\n"
            "Press [SPACE] to begin."
        )
    },
    'text_24': {
        'de': (
            "Sie beginnen nun eine Probesitzung! \n\n"
            "Bitte wählen Sie die Farbe der Buchstaben aus und ignorieren Sie dabei das Wort selbst. "
            "Versuchen Sie, Ihre Antworten so schnell wie möglich zu geben.\n\n"
            "rot = r \ngrün = g\nblau = b \ngelb = y\n\n"
            "Drücken Sie die [Leertaste] um zu beginnen."
        ),
        'en': (
            "This is a trial session!\n\n"
            "Choose the colour of the letters, ignoring the word itself. Try to press the respective key "
    ...
    'text_25': {
        'de': (
            "Sie beginnen nun die eigentliche Aufgabe! \n\n"
            "Bitte wählen Sie die Farbe der Buchstaben aus und ignorieren dabei das Wort selbst. "
            "Versuchen Sie, die entsprechende Taste so schnell wie möglich zu drücken.\n\n"
            "rot = r \ngrün = g\nblau = b \ngelb = y\n\n"
            "Drücken Sie die [Leertaste] um zu beginnen."
        ),
        'en': (
...
def _stroop(lang, continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref, target_3, response_stroop_3, sound_stroop_right_3, stroop_sound_wrong_3, num_reps=1.0, time_stroop=5.5, base_path=None, expInfo=None, Stroop_selfpacedClock=None, frameTolerance=None, FINISHED=None, endExpNow=None, defaultKeyboard=None, stroop_task_time_in_seconds=600):
...
def stroop(lang, continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref, easy=True, intro_test_only=False, num_reps=1.0, timely_shortened=False, seconds_to_stop=30, keyboard=None, base_path=None, frameTolerance=None, endExpNow=None, defaultKeyboard=None, expInfo=None, stroop_entire_task_time_in_seconds=600, stroop_example_time=35):
    ...
    text_2 = visual.TextStim(win=win_ref, name='text_2',
        #text= 'In der nächsten Aufgabe sehen Sie die Namen von Farben, abgebildet in derselben oder einer anderen Schriftfarbe. Wählen Sie die Schriftfarbe der folgenden Farbnamen und ignorieren Sie das eigentliche Wort. Drücken Sie schnell: \n\n rot = r \n grün = g \n blau = b \n gelb = y \n\n  Sie starten jetzt eine Probesitzung.\n\n Drücken Sie die [Leertaste] um zu beginnen.',
        text=STROOP_TEXT['text_2'][lang],
        font='Open Sans',
    ...
    text_24 = visual.TextStim(win=win_ref, name='text_24',
       # text='Sie beginnen nun eine Probesitzung! \n\n Bitte wählen Sie die Farbe der Buchstaben aus und ignorieren Sie dabei das Wort selbst. Versuchen Sie, Ihre Antworten so schnell wie möglich zu geben.\n\n rot = r \n grün = g\n blau = b \n gelb = y \n\n Drücken Sie die [Leertaste] um zu beginnen.',#'This is a trial session! \n\nChoose the colour of the letters, ignoring the word. Try to press the respective key as quickly as possible.\n\nred = r\ngreen = g\nblue = b\nyellow = y\n\nPress [SPACE] to start.',
        
        text=STROOP_TEXT['text_24'][lang],
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    text_25 = visual.TextStim(win=win_ref, name='text_25',
        #text='Sie beginnen nun die eigentliche Aufgabe! \n\n Bitte wählen Sie die Farbe der Buchstaben aus und ignorieren dabei das Wort selbst. Versuchen Sie, die entsprechende Taste so schnell wie möglich zu drücken.\n\n rot = r \n grün = g\n blau = b \n gelb = y \n\n Drücken Sie die [Leertaste] um zu beginnen.',#'This is the actual task! \n\nChoose the colour of the letters, ignoring the word. Try to press the respective key as quickly as possible.\n\nred = r\ngreen = g\nblue = b\nyellow = y\n\nPress [SPACE] to start.',
        
        text=STROOP_TEXT['text_25'][lang],
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    _stroop(lang,continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref, target_3, response_stroop_3, sound_stroop_right_3, stroop_sound_wrong_3, num_reps=num_reps, time_stroop=time_stroop, base_path=base_path, expInfo=expInfo, Stroop_selfpacedClock=Stroop_selfpacedClock, frameTolerance=frameTolerance, FINISHED=FINISHED, endExpNow=endExpNow, defaultKeyboard=defaultKeyboard, stroop_task_time_in_seconds=stroop_example_time)
