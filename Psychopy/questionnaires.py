...
def affective_slider(base_path, thisExp, routineTimer, win, frameTolerance, endExpNow, defaultKeyboard,lang):
    
    AFFECTIVE_INSTRUCTIONS = {
    'text_19': {
    'en': 'Move the slider to rate your level of Pleasure',
    'de': 'Bewegen Sie den Schieberegler, um den Grad Ihres Wohlbefindens zu bewerten.'
    },
    'text_20': {
    'en': 'Move the slider to rate your level of Arousal',
    'de': 'Bewegen Sie den Schieberegler, um den Grad Ihrer Aufmerksamkeit zu bewerten.'
    },
    ...
    buttonNext_5 = visual.ButtonStim(win,
                                     text=AFFECTIVE_INSTRUCTIONS[ 'button' ][lang] , font='Arvo',
                                     pos=(0, -0.4),
                                     letterHeight=0.03,
    ...
    text_19 = visual.TextStim(win=win, name='text_19',
                              #text='Bewegen Sie den Schieberegler, um  den Grad Ihres Wohlbefindens zu bewerten.',#'Move the slider to rate your level of Pleasure',
                              text=AFFECTIVE_INSTRUCTIONS['text_19'][lang],
                              font='Open Sans',
    ...
    text_20 = visual.TextStim(win=win, name='text_20',
                              #text='Bewegen Sie den Schieberegler, um den Grad Ihrer Aufmerksamkeit zu bewerten.',#'Move the slider to rate your level of Arousal',
                              text=AFFECTIVE_INSTRUCTIONS['text_20'][lang],
                              font='Open Sans',
...
def panas(continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref,frameTolerance, endExpNow, defaultKeyboard, lang):
     # adding all the english values
    TEXT = { 
                 'panas_welcome' :  { 
                 'en' :'Indicate the extent of the stated feelings right now ',
                 'de' : 'Geben Sie nun, für die angegebenen Gefühle, Ihre Empfindungen an.'
                 },
                 
                 'panas_space_hint' :  { 
                 'en' :'Press [SPACE] to continue',
                 'de' : 'Bitte drücken Sie die [LEERTASTE], um fortzufahren.'
                 },
    ...
    LABELS= { 
                 'en' : ['Very slightly or not at all', 'A little', 'Moderately', 'Quite a bit', 'Extremely'],
                 'de' : ['gar nicht', 'ein bisschen', 'einigermaßen', 'erheblich', 'äußerst'],
                 }
    ...
    textWelcome = visual.TextStim(win=win_ref, name='textWelcome',
        # text='Geben Sie nun, für die angegebenen Gefühle, Ihre Empfindungen an.',#'Indicate the extent of the stated feelings right now ',
        text = TEXT[ 'panas_welcome' ][lang] ,
        font='Open Sans',
    ...
    textSpaceHint = visual.TextStim(win=win_ref, name='textSpaceHint',
        #text='Bitte drücken Sie die [LEERTASTE], um fortzufahren.',#'Press [SPACE] to continue',
        text=TEXT[ 'panas_space_hint' ][lang] ,
        font='Open Sans',
    ...
    textInterested = visual.TextStim(win=win_ref, name='textInterested',
        #text='Interessiert',#'Interested',
        text=TEXT[ 'panas_interested' ][lang] ,
        font='Open Sans',
    ...
    sliderInterested = visual.Slider(win=win_ref, name='sliderInterested',
        ...
        labels=LABELS[lang], ticks=(1, 2, 3, 4, 5), granularity=1.0, 
    ...
    textDistressed = visual.TextStim(win=win_ref, name='textDistressed',
        #text='Bekümmert',#'Distressed',
        text=TEXT[ 'panas_distressed' ][lang] ,
        font='Open Sans',
    ...
    textExcited = visual.TextStim(win=win_ref, name='textExcited',
        #text='Freudig erregt',#'Excited',
        text=TEXT[ 'panas_exited' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.05), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-4.0);
    ...
    textUpset = visual.TextStim(win=win_ref, name='textUpset',
        #text='Verärgert',#'Upset',
        text=TEXT[ 'panas_upset' ][lang] ,
        font='Open Sans',
    ...
    buttonNext = visual.ButtonStim(win=win_ref, 
        text=TEXT[ 'button' ][lang] , font='Arvo',
        pos=(0.6, -0.4),
        letterHeight=0.03,
        size=(0.2, 0.1), borderWidth=0.0,
        fillColor='darkgrey', borderColor=None,
    ...
    textGuilty = visual.TextStim(win=win_ref, name='textGuilty',
        #text='Schuldig',#'Guilty',
        text=TEXT[ 'guilty' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.35), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textScared = visual.TextStim(win=win_ref, name='textScared',
        #text='Erschrocken',#'Verängstigt',#'Scared',
        text=TEXT[ 'scared' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.2), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textHostile = visual.TextStim(win=win_ref, name='textHostile',
        #text='Feindselig',#'Hostile',
        text=TEXT[ 'hostile' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.05), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textEnthusiastic = visual.TextStim(win=win_ref, name='textEnthusiastic',
        #text='Begeistert',#'Enthusiastic',
        text=TEXT[ 'Enthusiastic' ][lang] ,
        font='Open Sans',
        pos=(-0.6, -0.1), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textIrritable = visual.TextStim(win=win_ref, name='textIrritable',
        #text='Gereizt',#'Irritable',
        text=TEXT[ 'Irritable' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.35), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textAlert = visual.TextStim(win=win_ref, name='textAlert',
        #text='Wach',#'Aufmerksam',#'Alert',
        text=TEXT[ 'Alert' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.2), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textAshamed = visual.TextStim(win=win_ref, name='textAshamed',
        #text='Beschämt',#'Ashamed',
        text=TEXT[ 'Ashamed' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.05), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textInspired = visual.TextStim(win=win_ref, name='textInspired',
        #text='Angeregt',#'Inspiriert',#'Inspired',
        text=TEXT[ 'Inspired' ][lang] ,
        font='Open Sans',
        pos=(-0.6, -0.1), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textDetermined = visual.TextStim(win=win_ref, name='textDetermined',
        #text='Entschlossen',#'Determined',
        text=TEXT[ 'Determined' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.35), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textAttentive = visual.TextStim(win=win_ref, name='textAttentive',
        #text='Aufmerksam',#'Attentive',
        text=TEXT[ 'Attentive' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.2), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textJittery = visual.TextStim(win=win_ref, name='textJittery',
        #'text='Durcheinander',#'Jittery',
        text=TEXT[ 'Jittery' ][lang] ,
        font='Open Sans',
        pos=(-0.6, 0.05), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    textAfraid = visual.TextStim(win=win_ref, name='textAfraid',
        #text='Ängstlich',#'Afraid',
        text=TEXT[ 'Afraid' ][lang] ,
        font='Open Sans',
        pos=(-0.6, -0.25), height=0.03, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
...
def likertscale(lang, experiment_Ref, win_ref,  for_which='mental effort'):
    LIKERT_TEXT = {
    'instr': {
        'en': 'Please rate your {} on a 5-point Likert scale. Press [SPACE] to continue.',
        'de': 'Bitte bewerten Sie Ihr(e) {} auf einer 5-Punkte-Likert-Skala. Bitte drücken Sie [LEERTASTE], um fortzufahren.'
    },
    'item': {
        'en': 'In solving the preceding problem, my {} was:',
        'de': 'Bei der Lösung des vorherigen Problems war mein(e) {}:'
    },
    'choices': {
        'en': [
            'very very low',
    ...
    # instr = visual.TextStim(win_ref, text='Bitte bewerten Sie Ihr(e) {} auf einer 5-Punkte-Likert-Skala. Bitte drücken Sie [LEERTASTE], um fortzufahren.'.format(for_which) , height=.12, units='norm')
    instr = visual.TextStim(  win_ref, text=LIKERT_TEXT['instr'][lang].format(for_which), height=.12, units='norm' )
   # event.clearEvents()
    instr.draw()
    win_ref.flip()
...
#    myRatingScale = visual.RatingScale(win_ref, choices=['sehr niedrig', 'niedrig', 'weder niedrig noch hoch', 'hoch', 'sehr hoch'],stretch=2)#,
        #textSize=.12, textColor= 'white',textFont= 'Open Sans', pos=[0, -200],
        #acceptKeys='Space', maxTime=0.2)
    #myRatingScale = visual.RatingScale(win_ref, choices=['sehr niedrig', 'niedrig', 'weder noch', 'hoch', 'sehr hoch'], textSize=1.0, stretch=2)
    myRatingScale = visual.RatingScale(  win_ref, choices=LIKERT_TEXT['choices'][lang], textSize=0.5, stretch=2 )
   ...
   # myItem = visual.TextStim(win_ref, text="Bei der Lösung des vorherigen Problems war mein(e) {}: ".format(for_which), height=.12, units='norm')
    myItem = visual.TextStim( win_ref, text=LIKERT_TEXT['item'][lang].format(for_which), height=.12, units='norm')
...
def nasa(continueRoutine_Part, experiment_Ref, routine_timer_part, win_ref, endExpNow, defaultKeyboard, frameTolerance,lang):
    NASA_TEXT = { 
                 'Instructions_1' :  { 
                 'en' :'In the follwoing slides you will be answering few questions based on how you felt during the tasks (or video). \n\n\nPlease press space to continue.',
                 'de' :  'Auf den folgenden Folien werden Sie gebeten, einige Fragen dazu zu beantworten, wie Sie sich während der Aufgabe (oder des Videos) fühlten. \n\n\n Bitte drücken Sie die [LEERTASTE], um fortzufahren.'
                 },
                 
                 'Question1' :  { 
                 'en' :'Mental Demand\n\nHow mentally demanding was the task?',
                 'de' : 'Geistige Anforderung\n\nWie hoch waren die geistigen Anforderungen durch die Aufgabe?'
                 },
                 
                 'Question2' :  { 
                 'en' : 'Physical Demand \n\nHow physically demanding was the task?',
                 'de' : 'Körperliche Anforderung\n\nWie hoch waren die körperlichen Anforderungen durch die Aufgabe?'
                 },
                 
                'Question3' :  { 
                 'en' : 'Temporal Demand \n\nHow hurried or rushed was the pace of the task?',
                 'de' : 'Zeitliche Anforderung\n\nWie hoch war das Tempo, mit welchem die einzelnen Arbeitsschritte einander folgten?'
                 },
                ...
                'Instructions_2': {
                'en': (
                "In the following slides, 2 questions are presented."
                "Please select the workload dimension from each pair that was more significant during the task.\n"
                "For the chosen dimension, press the red square under the question."
                "Press \[SPACE\] to start."
                ),
                'de': (
                "Auf den folgenden Folien werden jeweils zwei Fragen angezeigt.\n\n"
                "Bitte wählen Sie das Kästchen der Arbeitsbelastungsdimension aus, die für Sie während der Aufgabe wichtiger war.\n"
                "Drücken Sie für die ausgewählte Dimension auf das rote Quadrat unter der Frage.\n"
               ...
               #   myRatingScale = visual.RatingScale(win_ref, choices=['sehr niedrig', 'niedrig', 'weder niedrig noch hoch', 'hoch', 'sehr hoch'],stretch=2)#,
                 ...
                 'goodbye':  { 
                 'en' : 'You have finished the questionnaire. Now you will continue to the second task.',
                 
                 'de' :'Sie haben den Fragebogen beantwortet. Sie werden nun mit der nächsten Aufgabe fortfahren.'
                 },
    ...
    Instructions_1 = visual.TextStim(win=win_ref, name='Instructions_1',
        text= NASA_TEXT['Instructions_1'][lang],
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    Question1 = visual.TextStim(win=win_ref, name='Question1',
        #text= 'Geistige Anforderung\n\nWie hoch waren die geistigen Anforderungen durch die Aufgabe?', #'Mental Demand\n\nHow mentally demanding was the task?',
        text= NASA_TEXT['Question1'][lang],
        font='Open Sans',
    ...
    LabelLeft1 = visual.TextStim(win=win_ref, name='LabelLeft1',
        text = NASA_TEXT['LabelLeft1'][lang],
        #text='Sehr niedrig',
        font='Open Sans',
    ...
    LabelRight1 = visual.TextStim(win=win_ref, name='LabelRight1',
        text = NASA_TEXT['LabelRight1'][lang],
        #text='Sehr hoch',
        font='Open Sans',
        pos=(0.5, -0.3), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    Question5 = visual.TextStim(win=win_ref, name='Question5',
        text= NASA_TEXT['Question5'][lang],
        #text= 'Anstrengung\n\nWie sehr mussten Sie sich anstrengen, um Ihre Leistung zu erreichen?',#'Effort \n\nHow hard did you have to work to accomplish your level of performance?',
        font='Open Sans',
        pos=(0, 0.05), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    Question6 = visual.TextStim(win=win_ref, name='Question6',
        text= NASA_TEXT['Question6'][lang],
        #text='Frustration\n\nWie verunsichert, entmutigt, gereizt, und verärgert waren sie?', #'Frustration \n\nHow insecure, discouraged, irritated, stressed,  and annoyed were you?',
        font='Open Sans',
        pos=(0, 0.05), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    Instructions_2 = visual.TextStim(win=win_ref, name='Instructions_2',
        text=NASA_TEXT['Instructions_2'][lang],
        #text='Auf den folgenden Folien werden jeweils zwei Fragen angezeigt.\n\n Bitte wählen Sie das Kästchen der Arbeitsbelastungsdimension aus, die für Sie während der Aufgabe wichtiger war. \n Drücken Sie für die ausgewählte Dimension auf das rote Quadrat unter der Frage.\n\n\n Bitte drücken Sie die [Leertaste] um zu beginnen.',#'In the following slides, 2 questions are presented.\n\nPlease select the workload dimension from each pair that was more significant during the task. \nFor the chosen dimension, press on the red square under the question.\n\n\nPress [SPACE] to start.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    Question23 = visual.TextStim(win=win_ref, name='Question23',
        #text='Körperliche Anforderung:\nWie hoch waren die körperlichen Anforderungen der Aufgabe? ',#Physical Demand:\nHow physically demanding was the task?',
        text= NASA_TEXT['Question2'][lang],
        font='Open Sans',
        pos=(0, 0.3), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    Question32 = visual.TextStim(win=win_ref, name='Question32',
         #text='Zeitliche Anforderung:\nWie hoch war das Tempo, mit dem die einzelnen Arbeitsschritte aufeinander folgten? ',# 'Temporal Demand:\nHow hurried or rushed was the pace of the task?',
        text= NASA_TEXT['Question3'][lang],
        font='Open Sans',
    ...
    Question45 = visual.TextStim(win=win_ref, name='Question45',
        #text='Leistung:\nWie erfolgreich haben Sie die geforderte Aufgabe ihrer Ansicht nach durchgeführt?',#'Performance:\nHow successful were you in accomplishing what you were asked to do?',
         text= NASA_TEXT['Question4'][lang],
        font='Open Sans',
        pos=(0, 0.3), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    Question12 = visual.TextStim(win=win_ref, name='Question12',
        #text='Geistige Anforderung:\nWie hoch waren die geistigen Anforderungen der Aufgabe?', #'Mental Demand:\nHow mentally demanding was the task?',
         text= NASA_TEXT['Question1'][lang],
        font='Open Sans',
        pos=(0, 0.3), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    Goodbye = visual.TextStim(win=win_ref, name='Goodbye',
        #text='Sie haben den Fragebogen beantwortet. Sie werden nun mit der nächsten Aufgabe fortfahren.',#'You have finished the questionnaire. Now you will continue to the second task.',
        text =NASA_TEXT['goodbye'][lang],
        font='Open Sans',
