...
def eye_closing(experiment_Ref, routine_timer_part, win_ref, eye_closing_timer, frameTolerance,endExpNow, defaultKeyboard, base_path, lang):
    ...
    texts= {
                 ...
                 'de' : 'Vielen Dank! \n\n Wir werden Sie nun bitten, Ihre Augen für eine Minute zu schließen und sich zu entspannen. Sie werden einen Ton hören wenn die Minute um ist.\n\n Bitte lassen Sie Ihre Augen so lange geschlossen, bis Sie das Geräusch hören. Sobald Sie startbereit sind, drücken Sie bitte mit geschlossenen Augen die [Leertaste].'
                 }
    ...
    sound_1.setVolume(1.0)
    text_hearing = {
                 'en' : 'Close your eyes until you hear a sound of the computer.',
                 'de' : 'Schließen Sie die Augen, bis Sie einen lauten Ton aus dem Computer hören.',
                 }
    text_17 = visual.TextStim(win=win, name='text_17',
                              #text='Schließen Sie die Augen, bis Sie einen lauten Ton aus dem Computer hören.',#'Close your eyes until you hear a sound of the computer.',
                              text =text_hearing[lang] ,
                              font='Open Sans',
                              pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0,
                              color='white', colorSpace='rgb', opacity=None,
                              languageStyle='LTR',
