...
def relaxation_video(base_path, thisExp, routineTimer, win, frameTolerance, endExpNow, defaultKeyboard,video_timer,lang):
    ...
    texts= {
                 'en' : "You are about to watch a video for the next 10 minutes. Please make sure that the computer's sound is on.\n\n\n\n\nPlease press [SPACE] to continue",
                 'de' : "In den nächsten 10 Minuten wird ein Video abgespielt. Bitte stellen Sie sicher, dass der Ton des Computers eingeschaltet ist.\n\n\n\n\n Bitte drücken Sie die [LEERTASTE] um fortzufahren."
                 }
    Welcome = visual.TextStim(win=win, name='Welcome',
                              
                              # text="In den nächsten 10 Minuten wird ein Video abgespielt. Bitte stellen Sie sicher, dass der Ton des Computers eingeschaltet ist.\n\n\n\n\n Bitte drücken Sie die [LEERTASTE] um fortzufahren.",#"You are about to watch a video for the next 10 minutes. Please make sure that the computer's sound is on.\n\n\n\n\nPlease press [SPACE] to continue",
                              text=texts[lang] ,
                              font='Open Sans',
